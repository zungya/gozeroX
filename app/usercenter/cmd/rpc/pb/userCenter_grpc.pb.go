...
const (
	...
	UserCenter_UpdateUserStats_FullMethodName   = "/pb.UserCenter/UpdateUserStats"
)
...
func (c *userCenterClient) UpdateUserStats(ctx context.Context, in *UpdateUserStatsReq, opts ...grpc.CallOption) (*UpdateUserStatsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateUserStatsResp)
	err := c.cc.Invoke(ctx, UserCenter_UpdateUserStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserCenterServer) UpdateUserStats(context.Context, *UpdateUserStatsReq) (*UpdateUserStatsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateUserStats not implemented")
}
...
func _UserCenter_UpdateUserStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateUserStatsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCenterServer).UpdateUserStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCenter_UpdateUserStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCenterServer).UpdateUserStats(ctx, req.(*UpdateUserStatsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserCenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserCenter_UpdateUserStats_Handler,
		},
	},
