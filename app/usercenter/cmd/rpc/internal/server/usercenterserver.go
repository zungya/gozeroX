...
func (s *UserCenterServer) UpdateUserStats(ctx context.Context, in *pb.UpdateUserStatsReq) (*pb.UpdateUserStatsResp, error) {
	l := logic.NewUpdateUserStatsLogic(ctx, s.svcCtx)
	return l.UpdateUserStats(in)
}
